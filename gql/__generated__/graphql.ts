...
export type CreateOrderMutation = { __typename?: 'Mutation', createOrder: { __typename?: 'CreateOrderResponse', orderId: string, amount: number, user_email: string, user_phone?: string | null } };
